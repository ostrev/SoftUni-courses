...
while True:
    ...
    if matrix[santa_row][santa_col] == 'V':
        ...
        # left row, col - 1
        if matrix[santa_row][santa_col - 1] == 'V' and number:
            nice_kids_presents += 1
            number -= 1
            matrix[santa_row][santa_col - 1] = '-'
        elif matrix[santa_row][santa_col - 1] == 'X' and number:
            number -= 1
            matrix[santa_row][santa_col - 1] = '-'
        # right row, col + 1
        if matrix[santa_row][santa_col + 1] == 'V' and number:
            ...
            matrix[santa_row][santa_col + 1] = '-'
        #up row - 1, col
        if matrix[santa_row - 1][santa_col] == 'V' and number:
            nice_kids_presents += 1
            number -= 1
            matrix[santa_row - 1][santa_col] = '-'
        elif matrix[santa_row - 1][santa_col] == 'X' and number:
            number -= 1
            matrix[santa_row - 1][santa_col] = '-'
        #down row + 1, col
        if matrix[santa_row + 1][santa_col] == 'V' and number:
    ...
    if number == 0 or total_nice_kids == nice_kids_presents:
        break
